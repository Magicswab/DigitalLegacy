...
def main():
    ...
    try:
        ...
        users = [
    ("u_owner_1",       "owner1",       _hash("1234"), "Owner One",       "owner",         read_public_key("owner1_public.pem")),
    ("u_advisor_1",     "advisor1",     _hash("1234"), "Advisor One",     "legal_advisor", read_public_key("advisor1_public.pem")),
    ("u_trustee_1",     "trustee1",     _hash("1234"), "Trustee One",     "trustee",       read_public_key("trustee1_public.pem")),
    ("u_beneficiary_1", "beneficiary1", _hash("1234"), "Beneficiary One", "beneficiary",   read_public_key("beneficiary1_public.pem")),
    ("u_beneficiary_2", "beneficiary2", _hash("1234"), "Beneficiary Two", "beneficiary",   read_public_key("beneficiary2_public.pem")),
]
